                        ...
                        <div class="row">
                          <div class="col-12 col-md-7">
                            <div class="form-group">
                              ...
                              <input name="nNome" id="iNome" type="text" maxlength="80" class="form-control" value="<?php echo htmlspecialchars($_SESSION['NomeFuncionario'] ?? ''); ?>" required>
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-md-5">
                            <div class="form-group">
                              ...
                              <input readonly name="nNivelAcesso" type="text" maxlength="50" class="form-control" value="<?php echo htmlspecialchars(descrTipoFuncionario($_SESSION['tipoFuncionario'] ?? '')); ?>"> 
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-md-7">
                            <div class="form-group">
                              <label>E-mail</label>
                              <input readonly type="email" class="form-control form-control-sm" name="nEmail" id="iEmail" value="<?php echo htmlspecialchars($_SESSION['EmailFuncionario'] ?? ''); ?>"> 
                            </div>
                          </div>
                          ...
                          <div class="col-12 col-md-5">
                            <div class="form-group">
                              ...
                              <input readonly type="text" class="form-control form-control-sm" name="nCampo1" id="iCampo1" value="<?php echo htmlspecialchars($_SESSION['TelefoneFuncionario'] ?? ''); ?>"> 
                            </div>
                          </div>
                        </div>

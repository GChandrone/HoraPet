                                ...
                                .'<div class="row">'
                                    ...
                                    .'<div class="col-4">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input type="text" value="'.$coluna["telefone"].'" class="form-control telefone-formatado" id="iTelefone" name="nTelefone" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-8">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input type="email" value="'.$coluna["email"].'" class="form-control" id="iEmail" name="nEmail" maxlength="50" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-3">'
                                        .'<div class="form-group">'
                                            .'<label>CEP</label>'
                                            .'<input value="'.$coluna["cep"].'" name="nCEP" id="iCEP" type="text" class="form-control cep" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-9">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input required value="'.$coluna["endereco"].'" name="nEndereco" id="iEndereco" type="text" class="form-control" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-3">'
                                        .'<div class="form-group">'
                                            .'<label>Número</label>'
                                            .'<input required value="'.$coluna["numero"].'" name="nNumero" id="iNumero" type="text" maxlength="8" class="form-control">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-9">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input name="nComplemento" value="'.$coluna["complemento"].'" id="iComplemento" type="text" maxlength="50" class="form-control">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-5">'
                                        .'<div class="form-group">'
                                            .'<label>Bairro</label>'
                                            .'<input required name="nBairro" value="'.$coluna["bairro"].'" id="iBairro" type="text" class="form-control" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-5">'
                                        .'<div class="form-group">'
                                            .'<label>Cidade</label>'
                                            .'<input required name="nCidade" value="'.$coluna["cidade"].'" id="iCidade" type="text" class="form-control" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-2">'
                                        .'<div class="form-group">'
                                            .'<label>UF</label>'
                                            .'<input required name="nUF" value="'.$coluna["estado"].'" id="iUF" type="text" class="form-control" required>'
                                        .'</div>'
                                    .'</div>'

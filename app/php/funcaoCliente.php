                            ...
                            .'<form method="POST" action="php/salvarCliente.php?funcao=A&codigo='.$coluna["id_cliente"].'" enctype="multipart/form-data">'              
                                ...
                                .'<div class="row">'
                                    ...
                                    .'<div class="col-3">'
                                        .'<div class="form-group">'
                                            .'<label>CEP</label>'
                                            .'<input required value="'.$coluna["cep"].'" name="nCEP" id="iCEP" type="text" class="form-control cep">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-9">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input required value="'.$coluna["endereco"].'" name="nEndereco" id="iEndereco" type="text" class="form-control">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-5">'
                                        .'<div class="form-group">'
                                            .'<label>Bairro</label>'
                                            .'<input required name="nBairro" value="'.$coluna["bairro"].'" id="iBairro" type="text" class="form-control">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-5">'
                                        .'<div class="form-group">'
                                            .'<label>Cidade</label>'
                                            .'<input required name="nCidade" value="'.$coluna["cidade"].'" id="iCidade" type="text" class="form-control">'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-2">'
                                        .'<div class="form-group">'
                                            .'<label>UF</label>'
                                            .'<input required name="nUF" value="'.$coluna["estado"].'" id="iUF" type="text" class="form-control">'
                                        .'</div>'
                                    .'</div>'

                            ...
                            .'<form method="POST" action="php/salvarServico.php?funcao=A&codigo='.$coluna["id_servico"].'" enctype="multipart/form-data">'              
                                ...
                                .'<div class="row">'
                                    ...
                                    .'<div class="col-3">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input type="text" value="'.formatarMoeda($coluna["valor"]).'" class="form-control valor-real" id="iValor" name="nValor" maxlength="11" placeholder="R$ 0,00" required>'
                                        .'</div>'
                                    .'</div>'
                                    ...
                                    .'<div class="col-3">'
                                        .'<div class="form-group">'
                                            ...
                                            .'<input type="time" value="'.$coluna["duracao"].'" class="form-control" id="iDuracao" name="nDuracao" maxlength="50" required>'
                                        .'</div>'
                                    .'</div>'
                                ...
                                .'<div class="form-group">'
                                    .'<div class="custom-control custom-checkbox">'
                                        .'<input class="custom-control-input custom-control-input-success" type="checkbox" id="iAtivoServico'.$coluna["id_servico"].'" name="nAtivoServico" '.$ativo.'>'

                            ...
                            .'<form id="formAjusteServico" data-servico-id="'.$coluna["id_servico"].'" method="POST" action="php/salvarServico.php?funcao=A&codigo='.$coluna["id_servico"].'" enctype="multipart/form-data">'              
                                ...
                                .'<div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">'
                                    .'<label class="btn btn-outline-info active btn-sm" onclick="mostrarCampos(\'pequeno\', \'modalEditServico' . $coluna['id_servico'] . '\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="portePequenoAlterar" autocomplete="off" checked> Pequeno'
                                    .'</label>'
                                    .'<label class="btn btn-outline-info btn-sm" onclick="mostrarCampos(\'medio\', \'modalEditServico' . $coluna['id_servico'] . '\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="porteMedioAlterar" autocomplete="off"> Médio'
                                    .'</label>'
                                    .'<label class="btn btn-outline-info btn-sm" onclick="mostrarCampos(\'grande\', \'modalEditServico' . $coluna['id_servico'] . '\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="porteGrandeAlterar" autocomplete="off"> Grande'
                                    .'</label>'
                                .'</div>'
                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_pequeno"]).'" class="form-control valor-real" id="valorPequenoAlterar'.$coluna["id_servico"].'" name="nValorPequeno" placeholder="R$ 0,00">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_medio"]).'" class="form-control valor-real" id="valorMedioAlterar'.$coluna["id_servico"].'" name="nValorMedio" placeholder="R$ 0,00">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_grande"]).'" class="form-control valor-real" id="valorGrandeAlterar'.$coluna["id_servico"].'" name="nValorGrande" placeholder="R$ 0,00">'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'

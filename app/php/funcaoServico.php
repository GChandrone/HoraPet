                ...
                .'<div class="modal-dialog modal-lg">'
                    .'<div class="modal-content">'
                        ...
                        .'<div class="modal-body">'
                            ...
                            .'<form method="POST" action="php/salvarServico.php?funcao=A&codigo='.$coluna["id_servico"].'" enctype="multipart/form-data">'              
                                ...
                                .'<div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">'
                                    .'<label class="btn btn-outline-info active btn-sm" onclick="mostrarCampos(\'pequeno\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="portePequeno" autocomplete="off" checked> Pequeno'
                                    .'</label>'
                                    .'<label class="btn btn-outline-info btn-sm" onclick="mostrarCampos(\'medio\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="porteMedio" autocomplete="off"> Médio'
                                    .'</label>'
                                    .'<label class="btn btn-outline-info btn-sm" onclick="mostrarCampos(\'grande\')">'
                                        .'<input type="radio" class="form-control" name="porte" id="porteGrande" autocomplete="off"> Grande'
                                    .'</label>'
                                .'</div>'

                                .'<div id="camposPequenoAlterar" class="porte-campos">'
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="valorPequeno">Valor (Pequeno):</label>'
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_pequeno"]).'" class="form-control valor-real" id="valorPequeno" name="nValorPequeno" placeholder="R$ 0,00" required>'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="duracaoPequeno">Duração (Pequeno):</label>'
                                                .'<input type="time" value="'.$coluna["duracao_pequeno"].'" class="form-control" id="duracaoPequeno" name="nDuracaoPequeno" required>'
                                            .'</div>'
                                        .'</div>'
                                    .'</div>'
                                .'</div>'
                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_medio"]).'" class="form-control valor-real" id="valorMedio" name="nValorMedio" placeholder="R$ 0,00" required>'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="duracaoMedio">Duração (Médio):</label>'
                                                .'<input type="time" value="'.$coluna["duracao_medio"].'" class="form-control" id="duracaoMedio" name="nDuracaoMedio" required>'
                                            .'</div>'
                                        .'</div>'
                                    .'</div>'
                                .'</div>'
                                    ...
                                    .'<div class="row">'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                ...
                                                .'<input type="text" value="'.formatarMoeda($coluna["valor_grande"]).'" class="form-control valor-real" id="valorGrande" name="nValorGrande" placeholder="R$ 0,00" required>'
                                            .'</div>'
                                        .'</div>'
                                        .'<div class="col-6">'
                                            .'<div class="form-group">'
                                                .'<label for="duracaoGrande">Duração (Grande):</label>'
                                                .'<input type="time" value="'.$coluna["duracao_grande"].'" class="form-control" id="duracaoGrande" name="nDuracaoGrande" required>'
                                            .'</div>'
                                        .'</div>'
                                    .'</div>'
                                .'</div>'

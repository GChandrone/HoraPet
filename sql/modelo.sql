...
--
-- Host: 127.0.0.1
-- Tempo de geração: 26-Out-2024 às 02:29
...
CREATE TABLE `pet` (
  ...
  `porte` int(11) NOT NULL COMMENT 'Porte do pet: | 1 - Mini | 2 - Pequeno | 3 - Médio | 4 - Grande | 5 - Gigante |',
...
--
ALTER TABLE `raca`
  MODIFY `id_raca` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Chave primária que identifica de forma única a raça', AUTO_INCREMENT=21;
